...
This new matrix $T$ can finally be used to turn a matrix $Z$ of i.i.d. standard normal variables into correlated returns. And to get the portfolio returns, we can multiply the returns matrix by the portfolio weights.
