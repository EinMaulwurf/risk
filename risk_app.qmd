...
Below is an interactive Shinylive-R app that allows you to select a portfolio of different S&P 500 stocks over a custom time horizon. You can then look at the portfolio returns as well as simple Value-at-Risk and Expected-Shortfall metrics for this portfolio.
...
write_csv(stock_returns, "stock_returns.csv")
```
